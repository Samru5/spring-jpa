...
<body>
    <div>
            <nav class="navi">
              ...
              <br>
              <center><h3>Check Balance</h3></center>

    <div class="container p-2 bg-dark text-success w-50" >
    <div class="form-group">
        <form action="/Spring-MVC-BankApp/app/bankapp/check" method="post">
        ...
        <button type="submit" class="btn btn-primary btn-block">Get Balance</button>
    </form>
    </div>
</div>
</body>
