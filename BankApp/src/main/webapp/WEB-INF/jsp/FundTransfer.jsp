...
<body>
    <div>
            <nav class="navi">
              ...
              <br>
              <center><h3>Fund Transfer</h3></center>

    <div class="container p-2 bg-dark text-success w-50" >
    <div class="form-group">
        <form action="/Spring-MVC-BankApp/app/bankapp/fund" method="post">
        
        <label for="from account">Sender Account ID:</label>
        <input type="text" class="form-control" id="fromaccount" name="fromaccount" placeholder="Please enter sender account id here" required><br>

        <div class="form-group">
                <label for="to account">Receiver Account ID:</label>
                <input type="text" class="form-control" id="toaccount" name="toaccount" placeholder="Please enter receiver account id here" required><br>
        

    </div>
    <div class="form-group">
        <label for="amount">Amount:</label>
        <input type="text" class="form-control" id="amount" name="amount" placeholder="Enter amount to be transfer" required><br><br>
